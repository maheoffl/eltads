...
function Header() {
  return (
      <header className=' sticky top-0 z-50 h-20 py-6 border-b bg-white bg-gradient-to-r from-indigo-100 to-indigo-50 font-sans text-[1.1vw] opacity-80'>
          <div className=" h-full w-full relative flex items-center justify-between px-32">
              ...
              <div className="links flex items-center gap-16 uppercase tracking-wide text-[1.0vw] font-medium text-black font-bold ">
